...
def send_invoice(token, chat_id, title, description, invoice_payload, provider_token, currency, prices,
    ...
    :param prices: Price breakdown, a list of components (e.g. product price.sqlite3, tax, discount, delivery cost, delivery tax, bonus, etc.)
    ...
    :param is_flexible: Pass True, if the final price.sqlite3 depends on the shipping method
    :param disable_notification: Sends the message silently. Users will receive a notification with no sound.
    :param reply_to_message_id: If the message is a reply, ID of the original message
    :param reply_markup: A JSON-serialized object for an inline keyboard. If empty, one 'Pay total price.sqlite3' button will be shown. If not empty, the first button must be a Pay button
    :param provider_data:
    :return:
    """
